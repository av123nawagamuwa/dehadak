    ...
    VitePWA({
        ...
        shortcuts: [
          {
            ...
            short_name: 'Search',
            description: 'Discover verified Sri Lankan matrimonial matches',
            url: '/search',
            icons: [{ src: '/icons/icon-96x96.png', sizes: '96x96' }]
          },
          {
            name: 'Messages & Interests',
            short_name: 'Messages',
            description: 'View connections and chat with matches',
            url: '/messages',
            icons: [{ src: '/icons/icon-96x96.png', sizes: '96x96' }]
          }
        ]
      ...
      workbox: {
        ...
        runtimeCaching: [
          ...
          // SECURITY RULE: Dynamic Backend API calls are strictly NetworkOnly
          // Never cache login, auth tokens, chat messages, or private user details
          {
            urlPattern: /\/api\/.*/i,
            handler: 'NetworkOnly',
            options: {
