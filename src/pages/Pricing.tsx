...
export default function PricingPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'Yes, there are zero recurring automatic lock-ins. You pay one-time for your chosen duration (3 months) and have full control over renewals. After 3 months, your account automatically converts to a Free Explorer account with zero unexpected charges.',
    },
    {
